...
<div id="main-container" class="overflow-x-hidden lg:flex  lg:justify-center lg:items-center">

    <div id="content" class="flex flex-col items-start justify-center p-8 gap-2 max-w-[80rem]">
